...
public class AppTest {
    ...
    public void setup() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter("c:\\report.html");
    ...
    public void test() throws IOException, InterruptedException {
        ...
        Thread.sleep(2000);
        FileInputStream fs = new FileInputStream("c:\\cw2Data.xlsx");
        Thread.sleep(2000);
